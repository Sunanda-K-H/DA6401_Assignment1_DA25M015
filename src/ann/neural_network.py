...
from src.ann.objective_functions import softmax
...
class NeuralNetwork:
    ...
    def __init__(self, cli_args):
        ...
        for h_size in cli_args.hidden_size:
            self.layers.append(Layer(in_curr, h_size, cli_args.activation, cli_args.weight_init))
            in_curr = h_size
        self.layers.append(Layer(in_curr, self.out_dim, None, cli_args.weight_init))
